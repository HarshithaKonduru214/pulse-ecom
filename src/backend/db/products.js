...
export const products = [
  ...
  },
  {
    ...
    brand: "calvin klien",
    img: "https://images-static.nykaa.com/media/catalog/product/6/5/65107400000_1.jpg",
    alt: "perfume-image",
    price: 3600,
    rating: 4.3,
    inStock: false,
  ...
  {
    _id: uuid(),
    name:"Nykaa Wanderlust Deodorant Spray - French Lavender",
  ...
  {
    _id: uuid(),
    name:"Engage Drizzle Deodorant For Women",
  ...
  {
    _id: uuid(),
    name:"Park Avenue Original Deo Good Morning",
  ...
  {
    _id: uuid(),
    name:"Nykaa Wanderlust Fragrance Body Mist - French Lavender",
